...
const _lazy_YNqpbJ = () => import('../routes/api/hello.mjs');
const _lazy_8I5mem = () => import('../routes/db.mjs');
const _lazy_syvOQ3 = () => import('../routes/h3-utils.mjs');
const _lazy_EyMLtg = () => import('../routes/hello.mjs');
const _lazy_xOfPOk = () => import('../routes/index1.mjs');
const _lazy_GnftEM = () => import('../routes/nitro-utils.mjs').then(function (n) { return n.n; });
const _lazy_KuZSXA = () => import('../routes/sse.mjs');
const _lazy_jfD3Ej = () => import('../routes/storge.mjs');
const _lazy_GJNz0w = () => import('../routes/websocket.mjs');
const _lazy_D5n26B = () => import('../routes/ws.mjs');

const handlers = [
  { route: '/api/hello', handler: _lazy_YNqpbJ, lazy: true, middleware: false, method: undefined },
  { route: '/db', handler: _lazy_8I5mem, lazy: true, middleware: false, method: undefined },
  { route: '/h3-utils', handler: _lazy_syvOQ3, lazy: true, middleware: false, method: undefined },
  { route: '/hello', handler: _lazy_EyMLtg, lazy: true, middleware: false, method: undefined },
  { route: '/index1', handler: _lazy_xOfPOk, lazy: true, middleware: false, method: undefined },
  { route: '/nitro-utils', handler: _lazy_GnftEM, lazy: true, middleware: false, method: undefined },
  { route: '/sse', handler: _lazy_KuZSXA, lazy: true, middleware: false, method: undefined },
  { route: '/storge', handler: _lazy_jfD3Ej, lazy: true, middleware: false, method: undefined },
  { route: '/websocket', handler: _lazy_GJNz0w, lazy: true, middleware: false, method: undefined },
  { route: '/ws', handler: _lazy_D5n26B, lazy: true, middleware: false, method: undefined }
];
...
export { getHeaders as a, useStorage as b, createEventStream as c, defineEventHandler as d, eventHandler as e, defineWebSocketHandler as f, getQuery as g, getRouteRulesForPath as h, useNitroApp as i, parseQuery as p, setHeader as s, toNodeListener as t, useDatabase as u, withQuery as w };
